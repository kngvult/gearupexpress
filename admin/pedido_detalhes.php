                    ...
                    <div class="order-items-list">
                        <?php foreach ($itens_pedido as $item): ?>
                            <div class="order-item" style="display: flex; align-items: center; padding: 15px 0; border-bottom: 1px solid #f0f0f0;">
                                <img src="<?= htmlspecialchars($item['imagem'] ?: 'placeholder.jpg') ?>" alt="<?= htmlspecialchars($item['nome_produto']) ?>" style="width: 60px; height: 60px; object-fit: cover; border-radius: 6px; margin-right: 15px;">
